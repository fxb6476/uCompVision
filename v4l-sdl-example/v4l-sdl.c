 ...
 */
				...
				// SDL libraries for visualization of images.
#include <SDL2/SDL.h>
...
static int 		pic_height = 360;
static int 		pic_width = 640;
...
static void mainloop(void)
{
		...
		// Delay 33 milliseconds makes about 30 fps.
		// Should be 33.333 ms
		delay(34);
        }
}
...
static void init_device(void)
{
	...
	//The window we'll be rendering to
	gWindow = SDL_CreateWindow( "SDL Tutorial", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, pic_width, pic_height, SDL_WINDOW_SHOWN );
